...
export const tours = {
  en: [
    ...
    },
    {
      ...
      faqs: [
        { q: "How do we get to Ilha Grande, and is it really a private speedboat?", a: "Yes, genuinely private. After a 3-hour scenic coastal drive from Rio to the pier, your group boards a private speedboat exclusively for your party. You are not sharing the boat with other tourists. The 5-hour island exploration includes secluded beaches, swimming, and snorkeling, all at your own pace." },
        ...
        { q: "What happens if the weather or sea conditions are not good?", a: "The route depends on weather and sea conditions, and safety and comfort come first. The team may adjust the island route, suggest a safer plan, or discuss rescheduling if conditions make the experience unsuitable." },
    ...
    */
    {
      ...
      faqs: [
        { q: "How far is Petrópolis from Rio and what is the drive like?", a: "Petrópolis is about 70km from Rio, roughly 1 to 1.5 hours by private vehicle through a spectacular mountain road that rises from sea level to 840 meters. The drive itself through the Serra dos Órgãos mountains is part of the experience." },
        { q: "Is the tour available every day of the week?", a: "Not available on Mondays, when most Petrópolis museums and palaces are closed. The tour runs Tuesday to Sunday." },
        ...
        { q: "Is Petrópolis better with a private guide?", a: "Petrópolis can be visited independently, but a private guide and driver make the day smoother from Rio. You get better timing, easier logistics between stops, historical context at each site, and a more comfortable pace throughout the mountain day trip." },
      ],
      tips: [
    ...
    */
    {
      ...
      faqs: [
        ...
        { q: "What's the minimum and maximum duration for a Custom Tour?", a: "Custom Tours range from 4 hours (half-day) to multi-day adventures. Most groups opt for a full day (8-10 hours). For longer itineraries, we can combine themes such as Petrópolis, Ilha Grande, Tijuca, Santa Teresa, food, culture, viewpoints, and historic Rio." },
      ...
      tips: [
        ...
        "Custom tours range from 4 hours (half-day) to longer itineraries combining active themes such as Petrópolis, Ilha Grande, Tijuca, Santa Teresa, food, culture, viewpoints, and historic Rio. Let us know your available time when you reach out.",
  ...
  es: [
    ...
    },
    {
      ...
      startTime: "05:30 - 07:30",
      faqs: [
        { q: "¿Cómo llegamos a Ilha Grande, y es realmente una lancha privada?", a: "Sí, genuinamente privada. Después de un pintoresco viaje de 3 horas desde Río hasta el muelle, tu grupo aborda una lancha privada exclusiva para tu grupo. No compartes la lancha con otros turistas. La exploración de 5 horas incluye playas apartadas, natación y snorkel, todo a tu ritmo." },
        ...
        { q: "¿Qué pasa si el clima o el estado del mar no son buenos?", a: "La ruta depende del clima y del estado del mar, y la seguridad y comodidad son prioridad. El equipo puede ajustar la ruta por la isla, sugerir un plan más seguro o conversar sobre una nueva fecha si las condiciones no son adecuadas para la experiencia." },
    ...
    */
    {
      ...
      faqs: [
        ...
        { q: "¿El tour está disponible todos los días de la semana?", a: "No está disponible los lunes, cuando la mayoría de los museos y palacios de Petrópolis cierran. El tour opera de martes a domingo." },
        ...
        { q: "¿Vale la pena visitar Petrópolis con guía privado?", a: "Petrópolis se puede visitar por cuenta propia, pero un guía y conductor privados hacen el día más fluido desde Río. Ayudan con los horarios, la logística entre paradas, el contexto histórico y un ritmo más cómodo durante la excursión a la sierra." },
      ],
      tips: [
    ...
    */
    {
      ...
      included: ["Transporte privado con conductor profesional", "Guía local certificado en tu idioma", "Consulta de planificación de itinerario personalizado", "Recogida y regreso en cualquier lugar de Río (hoteles, Airbnbs, aeropuertos y terminal de cruceros)", "Consejos locales, recomendaciones y acceso privilegiado", "Horarios flexibles y ajustes en tiempo real"],
      ...
      faqs: [
        ...
        { q: "¿Cuál es la duración mínima y máxima de un Tour Personalizado?", a: "Los tours personalizados van desde 4 horas (medio día) hasta itinerarios más largos. La mayoría opta por un día completo (8-10 horas). Para rutas más amplias, podemos combinar temas como Petrópolis, Ilha Grande, Tijuca, Santa Teresa, gastronomía, cultura, miradores y Río histórico." },
      ...
      tips: [
        ...
        "Los tours personalizados van desde 4 horas (medio día) hasta itinerarios más largos con temas activos como Petrópolis, Ilha Grande, Tijuca, Santa Teresa, gastronomía, cultura, miradores y Río histórico. Indícanos tu tiempo disponible cuando contactes.",
  ...
  'pt-br': [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: "O que acontece se o clima ou o mar não estiverem bons?", a: "O roteiro depende do clima e das condições do mar, e segurança e conforto vêm em primeiro lugar. A equipe pode ajustar a rota pela ilha, sugerir um plano mais seguro ou conversar sobre uma nova data se as condições não forem adequadas para a experiência." },
    ...
    */
    {
      ...
      faqs: [
        ...
        { q: "O passeio está disponível todos os dias da semana?", a: "Não está disponível às segundas-feiras, quando a maioria dos museus e palácios de Petrópolis fecha. O passeio funciona de terça a domingo." },
        ...
        { q: "Vale a pena visitar Petrópolis com guia privativo?", a: "Petrópolis pode ser visitada por conta própria, mas um guia e motorista privativos deixam o dia mais fluido saindo do Rio. Eles ajudam com horários, logística entre paradas, contexto histórico e um ritmo mais confortável durante o bate-volta na serra." },
      ],
      tips: [
    ...
    */
    {
      ...
      faqs: [
        { q: "Como funciona o Passeio Personalizado -- qual é o processo?", a: "Começa com uma conversa. Entre em contato via WhatsApp ou e-mail com seus interesses, tamanho do grupo, datas disponíveis e itens imperdíveis. Nossa equipe criará um roteiro personalizado para sua análise, ajustará conforme seu feedback e confirmará quando estiver satisfeito. Não há cobrança pelo processo de planejamento." },
        { q: "Qual é a duração mínima e máxima de um Passeio Personalizado?", a: "Os passeios personalizados vão de 4 horas (meio dia) a roteiros mais longos. A maioria opta por um dia completo (8-10 horas). Para rotas mais amplas, podemos combinar temas como Petrópolis, Ilha Grande, Tijuca, Santa Teresa, gastronomia, cultura, mirantes e Rio histórico." },
        { q: "Como o preço é determinado para um Passeio Personalizado?", a: "O preço varia conforme o roteiro, duração, tamanho do grupo e atrações selecionadas. Forneceremos um orçamento completo e transparente antes de você confirmar. Sem custos surpresa no dia do passeio." },
        { q: "O Passeio Personalizado pode acomodar pessoas com limitações de mobilidade?", a: "Sim -- esta é uma das principais razões pelas quais os viajantes escolhem o Passeio Personalizado. Podemos criar um roteiro que evite escadas, terrenos íngremes ou longas caminhadas, mantendo uma experiência excepcional. Mencione qualquer consideração de mobilidade ao entrar em contato." },
        { q: "Podemos combinar múltiplos passeios ou atrações que não estão no seu menu padrão?", a: "Com certeza -- esse é o objetivo do Passeio Personalizado. Seja um restaurante específico, bairro, evento ou atividade não coberta nos nossos passeios padrão, podemos incorporar. O Rio tem muito mais a oferecer do que qualquer passeio fixo pode cobrir e o conhecimento local dos nossos guias é extenso." },
      ],
      tips: [
        ...
        "Passeios personalizados vão de 4 horas (meio dia) até roteiros mais longos com temas ativos como Petrópolis, Ilha Grande, Tijuca, Santa Teresa, gastronomia, cultura, mirantes e Rio histórico. Informe seu tempo disponível ao entrar em contato.",
